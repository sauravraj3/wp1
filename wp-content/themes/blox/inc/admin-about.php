...
function cyberchimps_display_about() {
	...
	<div class="about-container">
		...
		<div class="about-info">
			<h1><?php echo "Blox - ".$theme['Version'] ?></h1>
			<?php
				$directory_uri = get_template_directory_uri();

			?>
			<span><img src="<?php echo $directory_uri ?>/images/logo.png"></span>
			<?php printf( '<p>Blox Free is a fully Responsive Drag & Drop Starter WordPress Theme that adds amazing new functionality to your WordPress website. Featuring Twitter Bootstrap, and responsive touch friendly theme options that work on any device.'
			); ?>
		</div>
		...
		<div class="buy">
		<a class="button button-primary buylink" target="_blank" href="https://cyberchimps.com/store/blox-pro/?utm_source=about">Buy Blox Pro</a>
		</div>
	</div>
<?php
}
